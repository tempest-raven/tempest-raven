...
export type languageObject = Record<sonnyLanguage, langData>;
export type langData = Partial<{
  BUFFSAY: Record<string, string>;
  ACH: string[];
  ACHDESC: string[];
  ACHSAY: string[];
  CUTSUB: string[];
  ...
  [x: string]: string | string[] | Record<string, string>;
}>;
